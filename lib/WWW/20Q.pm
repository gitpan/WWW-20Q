...
WWW::20Q - Perl interface to the classic 20 Questions game as provided by 20Q.net
...
Create a new instance of WWW::20Q. The only argument you should pass is B<debug>. Before
